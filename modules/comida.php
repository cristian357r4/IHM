        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-dark container-fluid">
                    ...
                    <tr>
                        <th>
                            <select class="selectpicker" multiple data-max-options="3" data-style="btn btn-primary btn-block" title="Cereales y Tuberculos">
                        ...
                        <td><a href="#" class="btn btn-primary btn-block disabled" style="font-family: 'Britannic Bold', monospace" role="button">3</a></td>
                    </tr>
                    <tr>
                        <th>
                            <select class="selectpicker" multiple data-max-options="2" data-style="btn btn-primary btn-block" title="Origen Animal">
                    ...
                    <tr>
                        <th>
                            <select class="selectpicker" multiple data-max-options="2" data-style="btn btn-primary btn-block" title=" Aceites">
